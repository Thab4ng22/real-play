...
function AskAI() {
  ...
  const send = async () => {
    ...
    const context = `You are an AI insights assistant for an e-commerce analytics SaaS dashboard called AI Insights. The user's store data: Revenue last 30d: $84,320 (+12.4%). AOV: $127.50. ROAS: 4.2x. Churn: 2.1%. LTV: $540. CAC: $38. Top products: Hoodie X ($18,400, 147 units), Classic Tee Bundle ($12,200), Cargo Shorts ($9,800). Ad channels: Meta ROAS 3.1x, TikTok ROAS 5.8x, Google ROAS 3.6x, Email ROAS 21x. You give short, specific, actionable advice like a top e-commerce growth advisor. Be concise, use numbers, and give real recommendations.`;
    ...
    <div style={{display:"flex",height:"100vh",overflow:"hidden",background:C.bg}}>
      ...
      <div style={{
        ...
        <div style={{padding:"20px 16px",borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",gap:10,height:65}}>
          ...
          {sidebarOpen && <span style={{fontSize:15,fontWeight:700,fontFamily:"'Syne',sans-serif",whiteSpace:"nowrap"}}>AI Insights</span>}
        </div>
    ...
    <div style={{minHeight:"100vh",background:C.bg}}>
      ...
      <nav style={{
        ...
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <span style={{fontSize:18,fontWeight:800,fontFamily:"'Syne',sans-serif"}}>AI Insights</span>
        </div>
      ...
      <section style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"120px 40px 80px",textAlign:"center",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{animation:"fadeUp 0.7s ease forwards",maxWidth:760}}>
          ...
          <p style={{fontSize:18,color:C.textSecondary,lineHeight:1.7,maxWidth:560,margin:"0 auto 40px"}}>
            AI Insights connects to your Shopify, Stripe & Ads accounts and delivers specific, AI-written recommendations every morning. Stop staring at dashboards — start acting.
          </p>
      ...
      <footer style={{borderTop:`1px solid ${C.border}`,padding:"30px 40px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:16}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <span style={{fontSize:14,fontWeight:700,fontFamily:"'Syne',sans-serif"}}>AI Insights</span>
        </div>
        <p style={{fontSize:12,color:C.textMuted}}>© 2025 AI Insights SaaS. Built for DTC e-commerce brands.</p>
