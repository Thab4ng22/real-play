# ⚡ AI Insights — E-Commerce Analytics SaaS
...
👉 **[View Live on GitHub Pages](https://YOUR-USERNAME.github.io/ai-insights-saas/)**
...
- **AI Insights Tab** — Daily prioritized action items
...
```bash
git clone https://github.com/YOUR-USERNAME/ai-insights-saas.git
cd ai-insights-saas
```
...
```js
base: '/ai-insights-saas/',   // ← must match your GitHub repo name exactly
```
...
```
https://YOUR-USERNAME.github.io/ai-insights-saas/
```
